...
// ReadProjectDependencies reads dependencies from project's package.json
func ReadProjectDependencies(projectPath string) (*PackageJSON, error) {
...
// ResolveVersionsFromInstalled returns versions based on what's actually installed
func ResolveVersionsFromInstalled(projectPath string, modules []string) (map[string]string, error) {
	...
	for _, moduleName := range modules {
		...
		resolved[moduleName] = NormalizeVersion(installed.Version)
	}
